...
products.forEach((product) => {
  ...
  productElement.className =
    "h-[520px] p-4 cursor-pointer transition-transform duration-300 hover:scale-105 shadow-lg hover:shadow-2xl rounded-lg space-y-4";
  productElement.innerHTML = `
    ...
    <div class="h-[30%] space-y-3">
      ...
      <a href="#" class="text-[16px] font-[700] underline">ORDER NOW</a>
    </div>
  `;
