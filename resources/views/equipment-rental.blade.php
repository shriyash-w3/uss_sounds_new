    ...
    <div class="wrapper">
        <div class="relative">
            ...
            <div class="absolute inset-0 flex flex-col justify-center items-center z-40 text-white text-center px-4 sm:px-8">
                <h2 class="text-3xl sm:text-4xl font-bold">EQUIPMENT RENTAL</h2>
    ...
    <script>
        ...
        function filterProducts() {
            ...
            <div class=" space-y-3 flex flex-col items-start justify-start">
              ...
              <a href="./inquiry.html" class="text-[14px] sm:text-[18px] lg:text-[16px] font-[700] pb-2 underline">RENT NOW</a>
            </div>
          `;
